...
def apply_watermark():
    ...
    s3_url = get_s3_url(filename, bucket_name)
    qr_req_url = f"https://qrackajack.expeditedaddons.com/?api_key={os.environ['QRACKJACK_API_KEY']}&bg_color=%23ffffff&content={s3_url}&fg_color=%23000000&height=256&width=256"
